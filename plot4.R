...
plot(Datasubset$Voltage~Datasubset$Time,type="l",ylab="Voltage (volt)",xlab="");
...
plot(Datasubset$Global_Reactive_Power ~Datasubset$Time,type="l",ylab="Global Reactive Power (kilowatts)",xlab="");
